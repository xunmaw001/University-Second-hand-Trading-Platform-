				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('shangpinxinxi','购物车')" @click="onAcrossTap('dingdanxinxi')" type="button" class="layui-btn">
								购物车
							</button>
																					<button v-if="isAuth('shangpinxinxi','联系商家')" @click="onAcrossTap('lianxishangjia')" type="button" class="layui-btn">
								联系商家
							</button>
