				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="qiwangjiaoyididian" id="qiwangjiaoyididian" placeholder="期望交易地点" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="shangpinjieshao" id="shangpinjieshao" placeholder="商品介绍" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																								...
                																								vue.shangpinleixing = '日用百货,书籍文具,个护美妆,电子产品'.split(',')
																																								// 上传图片
