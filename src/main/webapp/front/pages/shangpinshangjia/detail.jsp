				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('shangpinshangjia','上架商品')" @click="onAcrossTap('shangpinxinxi')" type="button" class="layui-btn">
								上架商品
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`shangpinshangjia`);
