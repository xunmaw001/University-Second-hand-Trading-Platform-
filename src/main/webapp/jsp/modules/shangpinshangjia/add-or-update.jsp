...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑商品上架</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>商品上架管理</span></li>
								<li class="breadcrumb-item active"><span>编辑商品上架</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">商品上架信息</h3>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<select id="shangpinleixingSelect" name="shangpinleixing" class="form-control">
												<option value=""></option>
												<option class="shangpinleixingOption" value="日用百货">
													日用百货
												</option>
												<option class="shangpinleixingOption" value="书籍文具">
													书籍文具
												</option>
												<option class="shangpinleixingOption" value="个护美妆">
													个护美妆
												</option>
												<option class="shangpinleixingOption" value="电子产品">
													电子产品
												</option>
										</select>	
									</div>	
									...
									<div class="form-group col-md-6">
										<label>期望交易地点</label>
										<input id="qiwangjiaoyididian" name="qiwangjiaoyididian" class="form-control" placeholder="期望交易地点">
									</div>
									<div class="form-group col-md-6">
										<label>图片</label>
									...
									<div class="form-group col-md-6">
										<label>商品介绍</label>
										<textarea name="shangpinjieshao" class="form-control" id="shangpinjieshao" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>账号</label>
	...
	<script>
		...
		var tableName = "shangpinshangjia";
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "shangpinshangjia/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("shangpinshangjia/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("shangpinshangjia/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("shangpinshangjia"+colName,"GET",{
				tableName: "shangpinshangjia",
				columnName: colName
			},(res)=>{
				if(res.code == 0){
		...
		function dataBind(){
			...
			$("#qiwangjiaoyididian").val(ruleForm.qiwangjiaoyididian);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.qiwangjiaoyididian != null && res.data.qiwangjiaoyididian != ''){

					$("#qiwangjiaoyididian").val(res.data.qiwangjiaoyididian);
					}
